...
class Cliente(Persona):
    ...
    def factura(self,pedido):
        ...
        archivo_factura = f"C:/Users/Augusto/Desktop/ESTRUCTURAS 2NDO P/EDP_G1/factura_{self.nombre}_{timestamp}.txt"
...
class Admin(Persona):
    ...
    def menu(self, tienda):
        ...
        def ver_estadisticas(self,tienda:Tienda):    
            ...
            if opcion == 1:
                ...
                sabores_pedidos=contador_sabores.keys()
                cantidad = contador_sabores.values()
